...
//	layui.link(layui.context+"/static/comp/tabs/tabs.css");
    ...
    $.fn.btab = function () {
        var thisObj = $(this);
        var _this = this;
        var _pageTabObj, _menuListObj, _menuAllObj, _menuAllUlObj, _pageTabContent, _pageContentObj, _pagePrevObj,
            _pageNextObj, _selectMenuList, _selectIframe, _selectMenuUl;
        /**
         * 初始化Tab
         */
        _this.init = function () {
